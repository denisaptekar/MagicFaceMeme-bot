...
async def start(message: types.Message):
    keyboard = types.InlineKeyboardMarkup(inline_keyboard=[
        [types.InlineKeyboardButton(text="🔥 Накачанный парень", callback_data="example1")],
        [types.InlineKeyboardButton(text="🎌 Аниме персонаж", callback_data="example2")],
        [types.InlineKeyboardButton(text="🤠 Ковбой", callback_data="example3")],
    ])
    await message.answer(
        "👋 Привет! Я — <b>MagicFace ✨</b>\n\n"
        "Отправь мне своё фото и напиши, во что хочешь себя превратить.\n\n"
        "Примеры:\n"
        "• сделай из меня накачанного парня\n"
        "• сделай из меня аниме персонажа\n"
        "• сделай из меня миллионера\n\n"
        "<b>Бесплатно: 3 трансформации в день</b>",
        parse_mode="HTML",
...
async def handle_message(message: types.Message):
    ...
    await message.answer("🔄 Генерирую... (10–25 секунд)")
